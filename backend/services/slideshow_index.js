...
exports.isRandomStrategy = isRandomStrategy;
exports.nextRandomIndex = nextRandomIndex;
exports.shuffleIndices = shuffleIndices;
exports.seedCurrentIndex = seedCurrentIndex;
exports.nextSlideshowIndex = nextSlideshowIndex;
function isRandomStrategy(strategy) {
 ...
 */
function seedCurrentIndex(opts) {
...
function nextSlideshowIndex(opts) {
    const n = opts.total;
    if (n <= 0)
        return 0;
    if (isRandomStrategy(opts.strategy)) {
