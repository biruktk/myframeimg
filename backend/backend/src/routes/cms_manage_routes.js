...
function attachCmsManageRoutes(adminRouter) {
    ...
    adminRouter.post("/admin/admins", rbac_1.requireSuperAdmin, (req, res) => {
        const body = (req.body ?? {});
    ...
    adminRouter.put("/admin/admins/:id", rbac_1.requireSuperAdmin, (req, res) => {
        const id = Number(req.params.id);
        const body = (req.body ?? {});
        let ok = false;
        store_1.db.mutate((draft) => {
    ...
    adminRouter.delete("/admin/admins/:id", rbac_1.requireSuperAdmin, (req, res) => {
        const id = Number(req.params.id);
        const data = store_1.db.read();
