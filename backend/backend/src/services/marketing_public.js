...
const marketing_translation_gaps_1 = require("../data/marketing_translation_gaps");
const store_1 = require("../db/store");
function mergeLocaleRecords(seed, stored, gapByLocale) {
...
function mergeTranslatedFeatures(seed, stored) {
    const locales = new Set([...Object.keys(seed), ...Object.keys(stored ?? {})]);
    const out = {};
    for (const locale of locales) {
...
function mergeMarketingSite(stored) {
    ...
    return {
        ...
        translations: mergeLocaleRecords(s.translations, (u.translations ?? {}), marketing_translation_gaps_1.marketingTranslationGaps),
        translatedFeatures: mergeTranslatedFeatures(s.translatedFeatures, (u.translatedFeatures ?? {})),
